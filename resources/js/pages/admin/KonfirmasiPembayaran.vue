...
<template>
    ...
    <CitechDashboardLayout activeMenu="admin.pembayaran" role="admin">
        <template #header-title>
            <h2 class="text-lg font-black tracking-wide text-slate-800">Konfirmasi Pembayaran</h2>
        </template>

        <div class="space-y-6 animate-fade-in-up">
            <div class="bg-white rounded-3xl p-6 md:p-8 shadow-[0_10px_35px_rgba(0,0,0,0.03)] border border-slate-100">
                <h3 class="text-xl font-extrabold text-slate-800">Verifikasi Bukti Pembayaran</h3>
                <p class="text-slate-500 text-sm mt-2 leading-relaxed">
                    Halaman ini digunakan oleh admin untuk memverifikasi bukti transaksi pembayaran tim peserta lomba.
                </p>
            </div>
        </div>
