...
<template>
    ...
    <CitechDashboardLayout activeMenu="admin.persyaratan" role="admin">
        <template #header-title>
            <h2 class="text-lg font-black tracking-wide text-slate-800">Konfirmasi Persyaratan</h2>
        </template>

        <div class="space-y-6 animate-fade-in-up">
            <div class="bg-white rounded-3xl p-6 md:p-8 shadow-[0_10px_35px_rgba(0,0,0,0.03)] border border-slate-100">
                <h3 class="text-xl font-extrabold text-slate-800">Verifikasi Dokumen Pendaftaran</h3>
                <p class="text-slate-500 text-sm mt-2 leading-relaxed">
                    Halaman ini digunakan oleh admin untuk memeriksa berkas administratif yang diunggah oleh peserta tim dan mengubah status verifikasinya.
                </p>
            </div>
        </div>
