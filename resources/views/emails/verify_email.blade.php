...
<head>
    ...
    <title>Verifikasi Alamat Email - Citech 2026</title>
    <style type="text/css">
                ...
                <table class="email-body" width="570" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #ffffff; border-radius: 24px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.04); overflow: hidden; width: 570px;">
                    ...
                    <tr>
                        <td class="email-content-cell" style="padding: 40px;">
                            ...
                            <p style="font-size: 14px; line-height: 1.6; margin-top: 0; margin-bottom: 24px;">Terima kasih telah mendaftar di **Carnival Technology UNEJ 2026**. Silakan klik tombol di bawah ini untuk memverifikasi alamat email Anda dan mengaktifkan akun Anda:</p>
                            
                            <!-- Action Button Container -->
                            <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom: 28px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $verificationUrl }}" class="button" style="background-color: #1e4d8c; border: 12px solid #1e4d8c; border-left: 28px solid #1e4d8c; border-right: 28px solid #1e4d8c; border-radius: 12px; color: #ffffff; display: inline-block; font-size: 14px; font-weight: 700; text-decoration: none; transition: background-color 0.3s; box-shadow: 0 4px 12px rgba(30, 77, 140, 0.25);">Verifikasi Email</a>
                                    </td>
                                </tr>
                            </table>
                            
                            <p style="font-size: 14px; line-height: 1.6; margin-top: 0; margin-bottom: 12px;">Tautan verifikasi ini akan kedaluwarsa dalam waktu **60 menit**.</p>
                            <p style="font-size: 14px; line-height: 1.6; margin-top: 0; margin-bottom: 24px; color: #64748b;">Jika Anda tidak merasa mendaftar di CITECH 2026, Anda dapat mengabaikan email ini.</p>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p style="font-size: 12px; line-height: 1.5; margin: 8px 0 0 0; word-break: break-all;">
                                            <a href="{{ $verificationUrl }}" style="color: #1e4d8c; text-decoration: underline; font-weight: 600;">{{ $verificationUrl }}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
